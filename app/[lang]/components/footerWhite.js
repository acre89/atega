...
export default function FooterWhite({dict}) {
  return (
    <div className="flex relative shadow-xl w-full overflow-hidden h-fit  md:h-[400px] gap-0">
      <div className="bg-white text-nav w-full md:w-[45%] pl-0 md:pl-12 lg:pl-28  mt-0 pt-10 z-30 pb-10 md:pb-0 flex flex-col justify-center md:justify-start items-center md:items-start">
        ...
        <div className="text-sm pt-10 pb-5 mx-5 md:mx-0 full-para">
          {dict.texte1}
        </div>
        <Link
