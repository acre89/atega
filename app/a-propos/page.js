        ...
        <div className="mx-40 mt-16">
          <div className="">
            <p className="pb-24 text-center text-xl ">
              ...
              clients dans leurs projets de cession, transmission, acquisition,
              levée de fond, recomposition de capital
            </p>
            <div className="flex flex-col md:flex-row md:justify-between pb-5 md:pb-16 ">
              <div className="w-fit">
                ...
                <ul className="list-disc text-xl pl-4">
                  <li>
                    Concrétiser les <span className="font-bold">ambitions</span>{" "}
                    des dirigeants-actionnaires
                  </li>
                  <li className="pt-5">
                    <em>Valoriser</em> le patrimoine professionnel des
                    entrepreneurs
                  </li>
                  <li className="pt-5">
                    Apporter un soutien <em>quotidien, complet</em> et{" "}
                    <em>exclusif</em>
                  </li>
                  <li className="pt-5">
                    <em>Simplifier</em> la complexité d’une opération
                    stratégique
                  </li>
                  <li className="pt-5">
                    Permettre aux entrepreneurs de{" "}
                    <em>se focaliser sur leurs activités opérationnelles </em>
                  </li>
                </ul>
              </div>
